...
public class TileTests
{
    ...
    public void GetColorIndex()
    {
        ...
        Assert.AreEqual(0b01, tile2.GetColorIndex(0, 7));
        Assert.AreEqual(0b10, tile2.GetColorIndex(0, 6));
        Assert.AreEqual(0b01, tile2.GetColorIndex(0, 5));
        Assert.AreEqual(0b11, tile2.GetColorIndex(0, 4));
        Assert.AreEqual(0b11, tile2.GetColorIndex(0, 3));
        Assert.AreEqual(0b10, tile2.GetColorIndex(0, 2));
        Assert.AreEqual(0b01, tile2.GetColorIndex(0, 1));
        Assert.AreEqual(0b10, tile2.GetColorIndex(0, 0));
    }
}
