...

{
    ...
    public bool CoincidenceFlag { get => TestBit(2, data); set => Write(value ? SetBit(2, data) : ResetBit(2, data)); }

    public override void Write(Byte value) => base.Write(value & 0xFC | Mode);
