...
public class ImprovedChannel2
{
    private readonly SystemState state;

    public ImprovedChannel2(SystemState state) => this.state = state;
    ...
    public void Tick()
    {
        ...
        {
            var envelope = new SimpleEnvelope(state.Channel2Envelope);
    ...
    public short[] GetNextSamples(int count)
    {
        ...
        var waveDuty = new SimpleWaveDuty(state.NR21);
